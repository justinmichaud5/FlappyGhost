...
public class Controller {
    ...
    public void setDebug(boolean debug) {
        ...
        for (Obstacle o : obstacles) {
            if (debug) {
                ...
                this.queen.getImageView().setImage(null);
            } else {
                o.getImageView().setImage(o.getImage());
            }
        }

        // Player debug and Boss debug
        if (debug) {
            ...
            this.queen.getImageView().setImage(this.queen.getImage());
        }
    }
    ...
    public void step(double deltaTime) {
        ...
        if (!bossFight) {
            ...
            if(this.collision(queen) && !this.debug) {
                this.reset = true;
            }
